...
import org.commonjava.web.user.model.SimpleUser;
...
public class UserResource
{
    ...
    public Listing<SimpleUser> listUsers()
    {
        // FIXME: Un-comment this!!
        // SecurityUtils.getSubject()
        // .checkPermission( Permission.name( User.NAMESPACE, Permission.ADMIN ) );

        return new Listing<SimpleUser>( SimpleUser.convert( dataManager.getUsers() ) );
    }
    ...
    @PUT
    @Path( "{name}" )
    public Response createUser( @PathParam( "name" ) final String name, final JAXBElement<SimpleUser> element )
    {
        // FIXME: Un-comment this!!
        // SecurityUtils.getSubject()
        // .checkPermission( Permission.name( User.NAMESPACE, Permission.ADMIN ) );
        ...
        // TODO: Validation!
        final SimpleUser user = element.getValue();
    ...
    @POST
    @Path( "{name}" )
    public Response updateUser( @PathParam( "name" ) final String name, final JAXBElement<SimpleUser> element )
    {
        // FIXME: Un-comment this!!
        // SecurityUtils.getSubject()
        // .checkPermission( Permission.name( User.NAMESPACE, Permission.ADMIN ) );
