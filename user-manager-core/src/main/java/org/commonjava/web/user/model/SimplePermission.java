    ...
    implements Permission
{
    ...
    public SimplePermission( final String... nameParts )
    {
        this.name = name( nameParts );
    }

    private SimplePermission( final String name, final Set<Permission> impliedPermissions )
    {
        this.name = name;
    ...
    public boolean equals( final Object obj )
    {
        ...
        final SimplePermission other = (SimplePermission) obj;
    ...
    public static SimplePermission convert( final List<Permission> permissions )
    {
        if ( permissions == null )
        {
            return null;
        ...
        final List<SimplePermission> perms = new ArrayList<SimplePermission>( permissions.size() );
    ...
    public static SimplePermission convert( final Permission permission )
    {
        return permission == null ? null : new SimplePermission( permission.getName(),
