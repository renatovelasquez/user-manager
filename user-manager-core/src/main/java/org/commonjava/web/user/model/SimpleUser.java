    ...
    implements User
{
    ...
    public SimpleUser( final String username, final String email, final String firstName, final String lastName,
    ...
    @Override
    public SimpleUser updateFrom( final User user )
    {
    ...
    public static List<SimpleUser> convert( final List<User> users )
    {
        if ( users == null )
        {
            return null;
        ...
        final List<SimpleUser> result = new ArrayList<SimpleUser>( users.size() );
    ...
    public static SimpleUser convert( final User user )
    {
        return user == null ? null : new SimpleUser( user.getUsername(), user.getEmail(), user.getFirstName(),
