    ...
    implements UserManagerConfiguration
{
    ...
    @Override
    public User getInitialAdminUser( final PasswordManager passwordManager )
    {
        return new User( User.ADMIN, adminEmail, adminFirstName, adminLastName,
                         passwordManager.digestPassword( adminPassword ) );
    }
